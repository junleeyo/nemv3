...
export default {
  ...
  methods: {
    ...
    postUser () {
      this.dialog = false
      axios.post('http://192.168.1.175:3000/api/user', {
    ...
    getUsers () {
      axios.get('http://192.168.1.175:3000/api/user')
        .then((r) => {
          // console.log(r.data)
    ...
    putUser () {
      this.dialog = false
      axios.put(`http://192.168.1.175:3000/api/user/${this.putId}`, {
        name: this.userName, age: this.userAge
      })
        .then((r) => {
          this.pop('사용자 수정 완료')
    ...
    delUser (id) {
      axios.delete(`http://192.168.1.175:3000/api/user/${id}`)
        .then((r) => {
          this.pop('사용자 삭제 완료')
          this.getUsers()
        })
    ...
    putReq () {
      axios.put('http://192.168.1.175:3000/api/user', {
        user: 'putMan'
      })
        .then((r) => {
    ...
    delReq () {
      axios.delete('http://192.168.1.175:3000/api/user')
        .then((r) => {
